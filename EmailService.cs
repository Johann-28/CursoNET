...
public static class EmailService{
    ...
    public static void SendMail(){
        ...
        message.From.Add(new MailboxAddress ("Johann Joseph", "johann_antonio85@hotmail.com"));
        message.To.Add(new MailboxAddress("Admin", "kingdrower11@gmail.com"));
        ...
        using (var client = new SmtpClient()){
            ...
            client.Authenticate("kingdrower11@gmail.com","kqramyomonkefewz");
            client.Send(message);
